...
export type SetSecretRequest = Message<"compass.v1.SetSecretRequest"> & {
  ...
  /**
   * tier the write targets; unspecified == user
   *
   * @generated from field: compass.v1.SecretScope scope = 7;
   */
  scope: SecretScope;
};
...
export type DeleteSecretRequest = Message<"compass.v1.DeleteSecretRequest"> & {
  ...
  /**
   * tier the delete targets; unspecified == user
   *
   * @generated from field: compass.v1.SecretScope scope = 2;
   */
  scope: SecretScope;
};
...
/**
 * @generated from message compass.v1.SetServerSecretRequest
 */
...
/**
 * Describes the message compass.v1.SetServerSecretRequest.
 * Use `create(SetServerSecretRequestSchema)` to create a new message.
 */
export const SetServerSecretRequestSchema: GenMessage<SetServerSecretRequest> = /*@__PURE__*/
  messageDesc(file_compass_v1_compass, 7);

/**
 * @generated from message compass.v1.SetServerSecretResponse
 */
export type SetServerSecretResponse = Message<"compass.v1.SetServerSecretResponse"> & {
};

/**
 * Describes the message compass.v1.SetServerSecretResponse.
 * Use `create(SetServerSecretResponseSchema)` to create a new message.
 */
export const SetServerSecretResponseSchema: GenMessage<SetServerSecretResponse> = /*@__PURE__*/
  messageDesc(file_compass_v1_compass, 8);

/**
 * @generated from message compass.v1.DeleteServerSecretRequest
 */
export type DeleteServerSecretRequest = Message<"compass.v1.DeleteServerSecretRequest"> & {
  /**
   * @generated from field: string name = 1;
   */
  name: string;
...
/**
 * Describes the message compass.v1.DeleteServerSecretRequest.
 * Use `create(DeleteServerSecretRequestSchema)` to create a new message.
 */
export const DeleteServerSecretRequestSchema: GenMessage<DeleteServerSecretRequest> = /*@__PURE__*/
  messageDesc(file_compass_v1_compass, 9);

/**
 * @generated from message compass.v1.DeleteServerSecretResponse
 */
export type DeleteServerSecretResponse = Message<"compass.v1.DeleteServerSecretResponse"> & {
};

/**
 * Describes the message compass.v1.DeleteServerSecretResponse.
 * Use `create(DeleteServerSecretResponseSchema)` to create a new message.
 */
export const DeleteServerSecretResponseSchema: GenMessage<DeleteServerSecretResponse> = /*@__PURE__*/
  messageDesc(file_compass_v1_compass, 10);

/**
 * @generated from message compass.v1.ListServerSecretsRequest
 */
export type ListServerSecretsRequest = Message<"compass.v1.ListServerSecretsRequest"> & {
};

/**
 * Describes the message compass.v1.ListServerSecretsRequest.
 * Use `create(ListServerSecretsRequestSchema)` to create a new message.
 */
export const ListServerSecretsRequestSchema: GenMessage<ListServerSecretsRequest> = /*@__PURE__*/
  messageDesc(file_compass_v1_compass, 11);

/**
 * @generated from message compass.v1.ListServerSecretsResponse
 */
export type ListServerSecretsResponse = Message<"compass.v1.ListServerSecretsResponse"> & {
  /**
   * @generated from field: repeated compass.v1.ServerSecretStatus server_secrets = 1;
   */
  serverSecrets: ServerSecretStatus[];
};

/**
 * Describes the message compass.v1.ListServerSecretsResponse.
 * Use `create(ListServerSecretsResponseSchema)` to create a new message.
 */
export const ListServerSecretsResponseSchema: GenMessage<ListServerSecretsResponse> = /*@__PURE__*/
  messageDesc(file_compass_v1_compass, 12);

/**
 * A declared server secret's status — the name plus set/unset ONLY, and NEVER
 * the value. A server secret is deployment-owned and never container-delivered,
 * so there is no delivery/kind routing to carry either. `name` is the STORED
 * name, carrying its reserved server-secret prefix; stripping the prefix for
 * display is the client's job, so the wire form stays unambiguous.
 *
 * @generated from message compass.v1.ServerSecretStatus
 */
export type ServerSecretStatus = Message<"compass.v1.ServerSecretStatus"> & {
  /**
   * @generated from field: string name = 1;
   */
  name: string;
...
/**
 * Describes the message compass.v1.ServerSecretStatus.
 * Use `create(ServerSecretStatusSchema)` to create a new message.
 */
export const ServerSecretStatusSchema: GenMessage<ServerSecretStatus> = /*@__PURE__*/
...
export type AgentSessionStatus = Message<"compass.v1.AgentSessionStatus"> & {
   ...
   *
   * @generated from field: compass.v1.RuntimeTier runtime_tier = 4;
   */
  runtimeTier: RuntimeTier;

  /**
   * @generated from field: compass.v1.EgressPosture egress_posture = 5;
   */
...
export type AgentAttribution = Message<"compass.v1.AgentAttribution"> & {
  ...
  /**
   * the owning user's handle, from the same header parse
   *
   * @generated from field: string owner_handle = 2;
   */
  ownerHandle: string;
};
...
export const ChecksSummarySchema: GenMessage<ChecksSummary> = /*@__PURE__*/
  messageDesc(file_compass_v1_compass, 79);
...
export const CheckSchema: GenMessage<Check> = /*@__PURE__*/
  messageDesc(file_compass_v1_compass, 80);
...
export const ChangedStatsSchema: GenMessage<ChangedStats> = /*@__PURE__*/
  messageDesc(file_compass_v1_compass, 81);
...
export const TrackerRefSchema: GenMessage<TrackerRef> = /*@__PURE__*/
  messageDesc(file_compass_v1_compass, 82);
...
export const ReviewSchema: GenMessage<Review> = /*@__PURE__*/
  messageDesc(file_compass_v1_compass, 83);
...
export const ReviewThreadSchema: GenMessage<ReviewThread> = /*@__PURE__*/
  messageDesc(file_compass_v1_compass, 84);
...
export const CommentSchema: GenMessage<Comment> = /*@__PURE__*/
  messageDesc(file_compass_v1_compass, 85);
...
/**
 * The tier a user-secret write targets. Names the same tiers as the store's
 * SecretScope* constants but NOT the same numbers: proto reserves 0 for
 * unspecified, so tenant is 2 here but 0 in the store — the handler maps
 * explicitly, never casts. The unspecified default is USER: a client that omits
 * the field writes its own private coordinate, never a tenant-wide value every
 * other user's agents resolve.
 *
 * @generated from enum compass.v1.SecretScope
 */
export enum SecretScope {
  /**
   * treated as USER — private by default
   *
  ...
  /**
   * @generated from enum value: SECRET_SCOPE_USER = 1;
   */
  USER = 1,
   ...
   * admin-only
   *
   * @generated from enum value: SECRET_SCOPE_TENANT = 2;
   */
  TENANT = 2,
}

/**
 * Describes the enum compass.v1.SecretScope.
 */
 ...
 *
 * @generated from enum compass.v1.RuntimeTier
 */
export enum RuntimeTier {
  /**
   * @generated from enum value: RUNTIME_TIER_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,

  /**
   * @generated from enum value: RUNTIME_TIER_PODMAN = 1;
   */
  PODMAN = 1,

  /**
   * @generated from enum value: RUNTIME_TIER_MICROVM = 2;
   */
  MICROVM = 2,

  /**
   * @generated from enum value: RUNTIME_TIER_APPLE_CONTAINER = 3;
   */
  APPLE_CONTAINER = 3,

  /**
   * @generated from enum value: RUNTIME_TIER_HOST = 4;
   */
  HOST = 4,
}

/**
 * Describes the enum compass.v1.RuntimeTier.
 */
export const RuntimeTierSchema: GenEnum<RuntimeTier> = /*@__PURE__*/
 ...
 */
export enum EgressPosture {
  /**
   * @generated from enum value: EGRESS_POSTURE_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,

  /**
   * @generated from enum value: EGRESS_POSTURE_ARMED = 1;
   */
  ARMED = 1,

  /**
   * @generated from enum value: EGRESS_POSTURE_UNENFORCED = 2;
   */
  UNENFORCED = 2,
}

/**
 * Describes the enum compass.v1.EgressPosture.
 */
export const EgressPostureSchema: GenEnum<EgressPosture> = /*@__PURE__*/
...
export const SessionErrorKindSchema: GenEnum<SessionErrorKind> = /*@__PURE__*/
  enumDesc(file_compass_v1_compass, 10);
...
export const IssueStateSchema: GenEnum<IssueState> = /*@__PURE__*/
  enumDesc(file_compass_v1_compass, 11);
...
export const ForgeProviderSchema: GenEnum<ForgeProvider> = /*@__PURE__*/
  enumDesc(file_compass_v1_compass, 12);
...
export const SecretsService: GenService<{
   ...
   *
   * @generated from rpc compass.v1.SecretsService.SetServerSecret
   */
  setServerSecret: {
    methodKind: "unary";
    input: typeof SetServerSecretRequestSchema;
   ...
   * overwrite or delete).
   *
   * @generated from rpc compass.v1.SecretsService.DeleteServerSecret
   */
  deleteServerSecret: {
    methodKind: "unary";
    input: typeof DeleteServerSecretRequestSchema;
    output: typeof DeleteServerSecretResponseSchema;
  },
  /**
   ...
   *
   * @generated from rpc compass.v1.SecretsService.ListServerSecrets
   */
  listServerSecrets: {
    methodKind: "unary";
    input: typeof ListServerSecretsRequestSchema;
    output: typeof ListServerSecretsResponseSchema;
  },
}> = /*@__PURE__*/
