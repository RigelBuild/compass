...
// agent applies. Contract (design §T5, `AgentControl` oneof): prompt/steer/deliver/
...
// The oneof VARIANTS are specified; the payload FIELDS are not — representing an inbound
...
// One decoded control op — exactly one `AgentControl` oneof variant.
