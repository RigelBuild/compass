...
export interface ToolSession {
	...
	/**
	 * Request a cooperative restart (session recycle) of the live session. Backs
	 * the `restart` tool. Absent on sessions with no backing `AgentSession` or no
	 * bound `onRestartRequested` host callback.
	 */
