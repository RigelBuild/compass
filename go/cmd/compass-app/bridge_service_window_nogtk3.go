...
// application is unavailable (main_nogtk3.go documents why). There is no webview
...
// bridge_service_window_gtk3.go, compiled into the shipped gtk3 shell.
package main

import "context"

// windowFromContext returns a nil windowDispatcher in the non-gtk3 build: there
...
// emitFrame). Matching windowFromContext in bridge_service_window_gtk3.go.
