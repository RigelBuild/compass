...
// sane segment; 255 bytes is the common path-segment limit. User writes are
// authenticated at the RPC edge and server-secret names are server-declared, so
// this bounds store bloat, not an exploit.
