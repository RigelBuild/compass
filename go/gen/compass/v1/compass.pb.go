...
var file_compass_v1_compass_proto_msgTypes = make([]protoimpl.MessageInfo, 69)
var file_compass_v1_compass_proto_goTypes = []any{
	...
	(*AgentAttribution)(nil),                // 68: compass.v1.AgentAttribution
	(*ForgeRef)(nil),                        // 69: compass.v1.ForgeRef
	(*Issue)(nil),                           // 70: compass.v1.Issue
	(*PullRequest)(nil),                     // 71: compass.v1.PullRequest
	(*ChecksSummary)(nil),                   // 72: compass.v1.ChecksSummary
	(*Check)(nil),                           // 73: compass.v1.Check
	(*ChangedStats)(nil),                    // 74: compass.v1.ChangedStats
	(*TrackerRef)(nil),                      // 75: compass.v1.TrackerRef
	(*Review)(nil),                          // 76: compass.v1.Review
	(*ReviewThread)(nil),                    // 77: compass.v1.ReviewThread
	(*Comment)(nil),                         // 78: compass.v1.Comment
...
var file_compass_v1_compass_proto_depIdxs = []int32{
	...
	70, // 11: compass.v1.SubscribeEventsResponse.issue:type_name -> compass.v1.Issue
	70, // 12: compass.v1.ListBoardIssuesResponse.issues:type_name -> compass.v1.Issue
	...
	9,  // 35: compass.v1.ForgeRef.provider:type_name -> compass.v1.ForgeProvider
	69, // 36: compass.v1.Issue.forge:type_name -> compass.v1.ForgeRef
	68, // 37: compass.v1.Issue.agent:type_name -> compass.v1.AgentAttribution
	79, // 38: compass.v1.Issue.updated_at:type_name -> google.protobuf.Timestamp
	8,  // 39: compass.v1.Issue.state:type_name -> compass.v1.IssueState
	71, // 40: compass.v1.Issue.prs:type_name -> compass.v1.PullRequest
	75, // 41: compass.v1.Issue.tracker:type_name -> compass.v1.TrackerRef
	69, // 42: compass.v1.PullRequest.forge:type_name -> compass.v1.ForgeRef
	68, // 43: compass.v1.PullRequest.agent:type_name -> compass.v1.AgentAttribution
	74, // 44: compass.v1.PullRequest.changed:type_name -> compass.v1.ChangedStats
	72, // 45: compass.v1.PullRequest.checks:type_name -> compass.v1.ChecksSummary
	76, // 46: compass.v1.PullRequest.reviews:type_name -> compass.v1.Review
	77, // 47: compass.v1.PullRequest.threads:type_name -> compass.v1.ReviewThread
	73, // 48: compass.v1.ChecksSummary.checks:type_name -> compass.v1.Check
	78, // 49: compass.v1.ReviewThread.comments:type_name -> compass.v1.Comment
	17, // 50: compass.v1.CompassService.GetServerInfo:input_type -> compass.v1.GetServerInfoRequest
	19, // 51: compass.v1.CompassService.WhoAmI:input_type -> compass.v1.WhoAmIRequest
	21, // 52: compass.v1.CompassService.SubscribeEvents:input_type -> compass.v1.SubscribeEventsRequest
	23, // 53: compass.v1.CompassService.ListBoardIssues:input_type -> compass.v1.ListBoardIssuesRequest
	44, // 54: compass.v1.CompassService.ProvisionAgentWorkspace:input_type -> compass.v1.ProvisionAgentWorkspaceRequest
	48, // 55: compass.v1.CompassService.StartAgentSession:input_type -> compass.v1.StartAgentSessionRequest
	50, // 56: compass.v1.CompassService.SpawnAgent:input_type -> compass.v1.SpawnAgentRequest
	52, // 57: compass.v1.CompassService.StopAgentSession:input_type -> compass.v1.StopAgentSessionRequest
	46, // 58: compass.v1.CompassService.RemoveAgentWorkspace:input_type -> compass.v1.RemoveAgentWorkspaceRequest
	54, // 59: compass.v1.CompassService.ReloadAgentSession:input_type -> compass.v1.ReloadAgentSessionRequest
	56, // 60: compass.v1.CompassService.GetAgentStatus:input_type -> compass.v1.GetAgentStatusRequest
	42, // 61: compass.v1.CompassService.SubscribeAgentSession:input_type -> compass.v1.SubscribeAgentSessionRequest
	58, // 62: compass.v1.CompassService.IssueToken:input_type -> compass.v1.IssueTokenRequest
	60, // 63: compass.v1.CompassService.RevokeToken:input_type -> compass.v1.RevokeTokenRequest
	62, // 64: compass.v1.CompassService.PutAgentConfig:input_type -> compass.v1.PutAgentConfigRequest
	64, // 65: compass.v1.CompassService.GetAgentConfigInfo:input_type -> compass.v1.GetAgentConfigInfoRequest
	66, // 66: compass.v1.CompassService.DeleteAgentConfig:input_type -> compass.v1.DeleteAgentConfigRequest
	10, // 67: compass.v1.SecretsService.SetSecret:input_type -> compass.v1.SetSecretRequest
	12, // 68: compass.v1.SecretsService.ListSecrets:input_type -> compass.v1.ListSecretsRequest
	15, // 69: compass.v1.SecretsService.DeleteSecret:input_type -> compass.v1.DeleteSecretRequest
	18, // 70: compass.v1.CompassService.GetServerInfo:output_type -> compass.v1.GetServerInfoResponse
	20, // 71: compass.v1.CompassService.WhoAmI:output_type -> compass.v1.WhoAmIResponse
	22, // 72: compass.v1.CompassService.SubscribeEvents:output_type -> compass.v1.SubscribeEventsResponse
	24, // 73: compass.v1.CompassService.ListBoardIssues:output_type -> compass.v1.ListBoardIssuesResponse
	45, // 74: compass.v1.CompassService.ProvisionAgentWorkspace:output_type -> compass.v1.ProvisionAgentWorkspaceResponse
	49, // 75: compass.v1.CompassService.StartAgentSession:output_type -> compass.v1.StartAgentSessionResponse
	51, // 76: compass.v1.CompassService.SpawnAgent:output_type -> compass.v1.SpawnAgentResponse
	53, // 77: compass.v1.CompassService.StopAgentSession:output_type -> compass.v1.StopAgentSessionResponse
	47, // 78: compass.v1.CompassService.RemoveAgentWorkspace:output_type -> compass.v1.RemoveAgentWorkspaceResponse
	55, // 79: compass.v1.CompassService.ReloadAgentSession:output_type -> compass.v1.ReloadAgentSessionResponse
	57, // 80: compass.v1.CompassService.GetAgentStatus:output_type -> compass.v1.GetAgentStatusResponse
	43, // 81: compass.v1.CompassService.SubscribeAgentSession:output_type -> compass.v1.AgentSessionFrame
	59, // 82: compass.v1.CompassService.IssueToken:output_type -> compass.v1.IssueTokenResponse
	61, // 83: compass.v1.CompassService.RevokeToken:output_type -> compass.v1.RevokeTokenResponse
	63, // 84: compass.v1.CompassService.PutAgentConfig:output_type -> compass.v1.PutAgentConfigResponse
	65, // 85: compass.v1.CompassService.GetAgentConfigInfo:output_type -> compass.v1.GetAgentConfigInfoResponse
	67, // 86: compass.v1.CompassService.DeleteAgentConfig:output_type -> compass.v1.DeleteAgentConfigResponse
	11, // 87: compass.v1.SecretsService.SetSecret:output_type -> compass.v1.SetSecretResponse
	13, // 88: compass.v1.SecretsService.ListSecrets:output_type -> compass.v1.ListSecretsResponse
	16, // 89: compass.v1.SecretsService.DeleteSecret:output_type -> compass.v1.DeleteSecretResponse
